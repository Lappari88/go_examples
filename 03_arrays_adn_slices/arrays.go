...
func main() {
	...
	//This is a slice. Slices are dynamically created and change in size

	var mySlice []int //Does not allocate memory

	myAllocatedSlice := make([]int, 10) // slice with 10 dynamically allocated int of value zero
	...
	// You cannot add to unallocated slice directly by mySlice[0] = 10. This will crash
	...
	fmt.Println("Partial sice", partialSlice)
